package demo.com.loginwithfirebase.view;

/**
 * Created by mobulous7 on 24/11/16.
 */
...
import demo.com.loginwithfirebase.R;
 ...
 * @version 2015.0512
 */
public class RippleViewLinearLay extends LinearLayout {
    ...
    public RippleViewLinearLay(Context context) {
        super(context);
    }

    public RippleViewLinearLay(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RippleViewLinearLay(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnRippleCompleteListener {
        void onComplete(RippleViewLinearLay rippleView);
    }
