 ...
 * @version 2015.0512
 */
public class RippleViewRelative extends RelativeLayout {
    ...
    public RippleViewRelative(Context context) {
        super(context);
    }

    public RippleViewRelative(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RippleViewRelative(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnRippleCompleteListener {
        void onComplete(RippleViewRelative rippleView);
    }
