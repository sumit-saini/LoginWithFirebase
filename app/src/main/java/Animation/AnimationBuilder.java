 ...
 */
//compile 'com.github.florent37:viewanimator:1.0.4' liber
public class AnimationBuilder {
    ...
    public AnimationBuilder flipHorizontalHalf() {
        return rotationX(90, -15, 15, 0);
    }
    public AnimationBuilder flipHorizontalFull() {
        return rotationX(360, -35, 35, 0);
    }
    ...
    public AnimationBuilder rollOutRight() {
        for (View view : views) {
            alpha(1, 0);
    ...
    public AnimationBuilder rollOutLeft(Activity activity) {
        for (View view : views) {
            alpha(1, 0);
            view.setBackgroundColor(activity.getResources().getColor(R.color.colorAccent));
            translationX(view.getWidth(), -900);
           // rotation(0, 360);
        }
        return this;
    }
